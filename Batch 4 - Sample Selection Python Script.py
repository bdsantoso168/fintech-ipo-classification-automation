...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul  2 10:11:25 2025
...
batch3_file_path = "Batch 3 - manual_classification_sample.xlsx"
df_batch3 = pd.read_excel(batch3_file_path)
...
batch3_names = df_batch3['NINAMES'].str.lower().str.strip()

# Filter out companies already in Batch 1, and 2
exclude_names = pd.concat([batch1_names, batch2_names, batch3_names]) #Add more as Batch Progress
...
new_sample.to_excel("Batch 4 - manual_classification_sample.xlsx", index=False)

print("✅ New batch of 100 companies selected and saved to 'Batch 4 - manual_classification_sample.xlsx'")